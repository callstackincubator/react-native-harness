...
// src/shared/run-harness.ts
var import_node_child_process = require("child_process");
var [packager, runner] = process.argv.slice(2);
if (!runner) {
...
var [cmd, args] = entry;
var child = (0, import_node_child_process.spawn)(cmd, args, { stdio: "inherit" });
