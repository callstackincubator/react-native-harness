...
To aid in debugging, you can forward all `console` output from the device through Jest.
...
When enabled, logs from the device are attached to the active Jest test result and displayed using Jest's console formatting.
